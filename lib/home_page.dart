  ...
  Widget _gameSection(){
    return Column(
      ...
      children: [
        ...
        Text('Dice Sum: $_diceSum',style: TextStyle(fontSize: 22),),
        if (_point > 0) Text('Your Point: $_point',style: TextStyle(fontSize: 26,color: Colors.green),),
        if (_point > 0 && !_isGameOver) const Text(
          'Keep Rolling Till You WIN',
          style: TextStyle(
              fontSize: 18,
              color: Colors.white,
